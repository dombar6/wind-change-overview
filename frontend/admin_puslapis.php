...
if (!isset($_SESSION["vartotojo_id"]) || $_SESSION["role"] !== 'admin') {
...
$query = "SELECT id, vartotojas, epastas, slaptazodis, role FROM vartotojai WHERE role = 'user'";
...
<head>
    <meta charset="UTF-8">
    <title>Admino portalas</title>
    <link rel="stylesheet" href="admin_style2.css">
</head>
<body>
	<h1>Administratoriaus portalas
        ...
        <tbody>
			<?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <form method="POST" action="admin_puslapis.php" style="display:inline;">
